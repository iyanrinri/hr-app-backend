...
export class SalaryHistoryService {
  ...
  async create(createSalaryHistoryDto: CreateSalaryHistoryDto): Promise<SalaryHistoryResponseDto> {
  ...
  async findOne(id: number): Promise<SalaryHistoryResponseDto> {
  ...
  async getEmployeeHistory(employeeId: number): Promise<SalaryHistoryResponseDto[]> {
  ...
  async getByChangeType(changeType: string): Promise<SalaryHistoryResponseDto[]> {
