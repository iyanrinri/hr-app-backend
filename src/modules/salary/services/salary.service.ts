...
export class SalaryService {
  ...
  async create(createSalaryDto: CreateSalaryDto): Promise<SalaryResponseDto> {
  ...
  async findOne(id: number): Promise<SalaryResponseDto> {
  ...
  async getCurrentSalary(employeeId: number): Promise<SalaryResponseDto> {
  ...
  async getEmployeeSalaryHistory(employeeId: number): Promise<SalaryResponseDto[]> {
  ...
  async update(id: number, updateSalaryDto: UpdateSalaryDto): Promise<SalaryResponseDto> {
