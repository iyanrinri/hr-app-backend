...
export class SettingsService {
  ...
  async create(createSettingDto: CreateSettingDto, userId: bigint) {
  ...
  async update(key: string, updateSettingDto: UpdateSettingDto, userId: bigint) {
  ...
  async getCompanyInfo() {
    const companySettings = await this.settingsRepository.getByCategory(SettingCategory.COMPANY);
  ...
  async getAttendanceSettings() {
    const attendanceSettings = await this.settingsRepository.getByCategory(SettingCategory.ATTENDANCE);
  ...
  async initializeDefaultSettings(userId: bigint) {
    const defaultSettings = [
      ...
      // System settings
      { key: 'system_language', value: 'en', category: SettingCategory.SYSTEM, description: 'Default application language', dataType: SettingDataType.STRING, isPublic: true },
      { key: 'system_timezone', value: 'UTC', category: SettingCategory.SYSTEM, description: 'Default timezone', dataType: SettingDataType.STRING, isPublic: false },
      { key: 'system_date_format', value: 'YYYY-MM-DD', category: SettingCategory.SYSTEM, description: 'Date display format', dataType: SettingDataType.STRING, isPublic: true },
      { key: 'system_time_format', value: '24h', category: SettingCategory.SYSTEM, description: 'Time display format (12h/24h)', dataType: SettingDataType.STRING, isPublic: true },
