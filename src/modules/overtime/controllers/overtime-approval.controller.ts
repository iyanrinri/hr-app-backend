...
export class OvertimeApprovalController {
  ...
  async create(@Body() createOvertimeApprovalDto: CreateOvertimeApprovalDto): Promise<OvertimeApprovalResponseDto> {
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - SUPER/HR/MANAGER role required' })
  async findOne(@Param('id', ParseIntPipe) id: number): Promise<OvertimeApprovalResponseDto> {
