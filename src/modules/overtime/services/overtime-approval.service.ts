...
export class OvertimeApprovalService {
  ...
  async create(createOvertimeApprovalDto: CreateOvertimeApprovalDto): Promise<OvertimeApprovalResponseDto> {
  ...
  private async updateOvertimeRequestStatus(overtimeRequestId: bigint): Promise<void> {
  ...
  async findOne(id: number): Promise<OvertimeApprovalResponseDto> {
