...
export class OvertimeRequestService {
  ...
  async create(createOvertimeRequestDto: CreateOvertimeRequestDto): Promise<OvertimeRequestResponseDto> {
  ...
  private async createApprovalWorkflow(overtimeRequestId: bigint, employeeId: bigint): Promise<void> {
  ...
  async findOne(id: number): Promise<OvertimeRequestResponseDto> {
  ...
  async getEmployeeIdByUserId(userId: string): Promise<bigint | null> {
